...
class ConfigLoader:
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            if self.yacy_settings is None or self.flask_settings is None or self.socket_settings is None:
                raise ValueError("Invalid configuration file")
        
        except Exception as e:
            config_logger.error(f"An error occurred while loading the configuration: {e}")
            raise e
